    ...
    >
      <a href={url} style={{ height: '236px' }}>
        <img
          ...
          src={result._source.logo}
          width='170'
          style={{ margin: 'auto' }}
        />
        <div
          data-qa='position'
          className={bemBlocks.item('position')}
          dangerouslySetInnerHTML={{ __html: source.position }}
          style={{ position: 'absolute', top: '180px', left: '15px' }}
        ></div>
      </a>
    </div>
  );
      ...
      >
        <div className={bemBlocks.item('poster')}>
          <img
            ...
            alt='No Logo Given!'
            data-qa='poster'
            src={source.company_logo_url || source.job_post_image_url}
          />
        </div>
        <div>
          {source.tags &&
        ...
        <div className={bemBlocks.item('details')}>
          ...
          <div
            ...
            dangerouslySetInnerHTML={{ __html: source.description_html }}
          ></div>
        </div>
      </div>
    </Card>
